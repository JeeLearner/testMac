package com.lyd.tool.generator.utils;
...
import com.lyd.tool.generator.entity.ColumnEntity;
...
public class GenUtil {
	...
	public static void generatorCode(Map<String, String> table, List<Map<String, String>> columns, ZipOutputStream zip) throws Exception {
		...
		map.put("csdn", config.getString("csdn"));
		map.put("datetime", DateUtil.getDate());
		map.put("proName", config.getString("proName"));
