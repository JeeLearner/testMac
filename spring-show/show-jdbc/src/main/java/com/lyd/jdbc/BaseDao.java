...
public abstract class BaseDao{
	...
	public String baseCreate(final BaseMap<String, Object> createmap, String table_name, String id_name) throws Exception {
	...
	@SuppressWarnings("unused")
	public String saveOrUpdate(final BaseMap<String, Object> createmap, String table_name, String id_name, String[] unionkey) throws Exception {
		UUID uuid = UUID.randomUUID();
		String id = uuid.toString().replaceAll("-", "");
		StringBuilder sql = new StringBuilder();
		sql.append("INSERT").append(" INTO ").append(table_name).append("(");
		...
		final BaseMap<String, Object> updatemap = new BaseMap<String, Object>();
	...
	public void sqlappen(StringBuilder sql, String name, String value, boolean blurred) throws Exception {
		if (DataTypeUtil.checkString(value)) {
	...
	public void sqlappen(StringBuilder sql, String name, Double value) {
		if (DataTypeUtil.checkDouble(value)) {
	...
	public void sqlappen(StringBuilder sql, String name, Long value) throws Exception {
		if (DataTypeUtil.checkLong(value)) {
	...
	public void sqlappen(StringBuilder sql, String name, Integer value) {
		if (DataTypeUtil.checkInteger(value)) {
			sql.append(" AND ").append(name).append("=").append(value);
		}
	}
	...
	public void sqlappen(StringBuilder sql, String name, Float value) {
		if (DataTypeUtil.checkFloat(value)) {
	...
	public void sqlappen(StringBuilder sql, String name, Object[] array) {
		if (DataTypeUtil.checkObjectArray(array, 2)) {
	...
	public void sqlappen(StringBuilder sql, String name, Object Start, Object End) {
		if (Start instanceof String && DataTypeUtil.checkString((String) Start)) {
			sql.append(" AND ").append(name + "<").append("'").append((String) Start).append("'");
		}
		if (End instanceof String && DataTypeUtil.checkString((String) End)) {
			sql.append(" AND ").append(name + ">").append("'").append((String) End).append("'");
		}
		if (Start instanceof Integer && DataTypeUtil.checkInteger((Integer) Start)) {
			sql.append(" AND ").append(name).append("<" + "'").append((Integer) Start).append("'");
		}
		if (End instanceof Integer && DataTypeUtil.checkInteger((Integer) End)) {
			sql.append(" AND ").append(name).append(">").append("'").append((Integer) End).append("'");
		}
		if (Start instanceof Float && DataTypeUtil.checkFloat((Float) Start)) {
			sql.append(" AND ").append(name).append("<").append("'").append((Float) Start).append("'");
		}
		if (End instanceof Float && DataTypeUtil.checkFloat((Float) End)) {
