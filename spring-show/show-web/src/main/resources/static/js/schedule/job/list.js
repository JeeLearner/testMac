var vm = new Vue({
    ...
    methods : {
        ...
        update : function() {
            ...
            $.get(rootPath + "/schedule/schedule_do/get.do?jobId=" + jobId, function(r) {
                vm.showList = false;
                vm.title = "修改";
        ...
        saveOrUpdate : function(event) {
            var url = vm.schedule.jobId == null ? rootPath + '/schedule/schedule_do/create.do' : rootPath + '/schedule/schedule_do/update.do';
            $.ajax({
                type : "POST",
                url : rootPath + url,
        ...
        del : function() {
            ...
            confirm('确定要删除选中的记录？', function() {
                $.ajax({
                    type : "POST",
                    url : rootPath + "/schedule/schedule_do/deleteBatch.do",
                    // contentType : "application/json",
                    data : {
                        jobIds : jobIds
                    },
        ...
        start : function() {
            ...
            confirm('确定要开启选中的记录？', function() {
                $.ajax({
                    type : "POST",
                    url : rootPath + "/schedule/schedule_do/start.do",
                    // contentType : "application/json",
                    data : {
                        jobIds : jobIds
                    },
        ...
        resume : function() {
            ...
            confirm('确定要复位选中的记录？', function() {
                $.ajax({
                    type : "POST",
                    url : rootPath + "/schedule/schedule_do/resume.do",
                    // contentType : "application/json",
                    data : {
                        jobIds : jobIds
                    },
        ...
        runOnce : function() {
            ...
            confirm('确定要立即执行选中的记录？', function() {
                $.ajax({
                    type : "POST",
                    url : rootPath + "/schedule/schedule_do/run.do",
                    // contentType : "application/json",
                    data : {
                        jobIds : jobIds
                    },
...
$(function() {
    grid = lyGrid({
        ...
        jsonUrl : rootPath + '/schedule/schedule_do/list.do',
        checkbox : true,
        checkValue : 'jobId',
    });
